...
end =  "202307151000" #input("Enter a end date and time to pull wind data from (YYYYmmddHHMM):") 
...
for station in stid:
    result = myfunc.apirequest(interval, station, start, end)
    ...
    plt.savefig('interp_comparison_multiplestations.pdf')
